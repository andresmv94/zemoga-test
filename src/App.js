      ...
      <nav className="nav" role="navigation">
        <div className="max-centered">
          ...
          <ul className="nav__links">
            ...
            <li>
              <form action="dangerouslySetInnerHTML">
                <input
      ...
      <div className="max-centered">
        ...
        <main role="main">
          <div className="header">
            <p className="title">Previous Rulings</p>
            {!isMobile && (
              <select
          ...
          <div className="big-grid">
            <div className={cardType === "grid" ? "grid" : ""}>
              {data?.data &&
                data.data.map((element, key) => {
                  const sum = element.votes.positive + element.votes.negative;
                  const positive = (
                    (element.votes.positive * 100) /
                    sum
                  ).toFixed(1);
                  const negative = (
                    (element.votes.negative * 100) /
                    sum
                  ).toFixed(1);
                  return (
                    <CardComponent
                      ...
                      winner={positive >= negative ? "positive" : "negative"}
                      wasVoted={wasVoted}
                      voteAgain={voteAgain}
                      cardType={cardType}
                    />
